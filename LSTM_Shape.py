...
def train(features,classifier,train_loader,vali_loader,test_loader):
    ...
    with torch.no_grad():
        ...
        torch.save(model.state_dict(),model_dir+'lstm_shape_dict.pth')
...
train_dataset=PictureDataset(file_path='./Database/Real/depth/',csv_path='./csv_clothes/real/depth/LOOD_75_full.csv',idx_column=4,transforms=transforms)
test_dataset=PictureDataset(file_path='./Database/Real/depth/',csv_path='./csv_clothes/real/depth/LOOD_25_full.csv',idx_column=4,transforms=transforms)
...
alexnet=AlexNet()
alexnet.load_state_dict(torch.load('./alexnet_model/alexnet_shape_dict.pth'))
...
o=[o_z*100,o_o*100,o_tw*100,o_th*100,o_f*100]
